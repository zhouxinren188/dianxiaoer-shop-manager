...
const validInvokeChannels = [
  ...
  'set-auth-token',
  'proxy-fetch',
  'purchase-dialog-render-timing',
  'prepare-purchase-order-url',
  ...
  'toggle-aftersale-auto-sync',
  'aftersale-auto-sync-status',
  'sync-settlement-overview',
  'open-store-backend-url',
  'open-jd-outbound',
  'open-jd-order-detail',
  'submit-vendor-remark',
  'process-stock-remark-tasks',
  'open-purchase-url',
  'open-log-file',
  'generate-qrcode',
