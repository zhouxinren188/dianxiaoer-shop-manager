...
const { PENDING_INVOICE_QUERY_RENDERER_SOURCE } = require('./finance-page-query-scripts')
const {
...
function buildPendingInvoiceDirectQueryScript() {
  return `(async function() {
    try {
      var response = await ${PENDING_INVOICE_QUERY_RENDERER_SOURCE}(${JSON.stringify(JD_PENDING_INVOICE_API)}, ${JSON.stringify(JD_PENDING_INVOICE_APP_ID)});
